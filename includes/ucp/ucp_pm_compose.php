...
*
* @package ucp
* @version $Id: ucp_pm_compose.php 9494 2009-04-28 16:16:24Z acydburn $
...
//-- add
	...
	if(!$auth->acl_get('u_url') && $user->data['user_type'] != USER_FOUNDER)
	{
		if(!function_exists('authorized_url'))
		{
			include($phpbb_root_path . 'includes/authorized_url.' . $phpEx);                        
		}
