...
//-- mod : daroPL_AntiSpam -------------------------------------------------
//-- mod : add
		$confirm_code_hash = request_var(sha1($config['cookie_name'] . 'UESPsalt'), '');
//-- mod: fin add
...
//-- mod: add
			if ($data['tz'] < -11.8)
				$error[] = "Please do not select timezone UTC-12 as this timezone implies that you are a spambot. If this really is your preferred timezone, you may select it after registration through the User Control Panel";
//-- fin mod : BakerIsland -------------------------------------------------

//-- mod : daroPL_AntiSpam -------------------------------------------------
//-- mod: add
			if (empty($confirm_code_hash))
				$error[] = $user->lang['SPAMBOT_REGISTER'];
//-- fin mod : daroPL_AntiSpam ---------------------------------------------
...
//-- mod : daroPL_AntiSpam -------------------------------------------------
//-- mod : add
		$confirm_code_name_field = sha1(time() . rand());
//-- mod: fin add
		$s_hidden_fields = array(
			'agreed'		=> 'true',
			'change_lang'	=> 0,
//-- mod : add
			sha1($config['cookie_name'] . 'UESPsalt') => $confirm_code_name_field,
//-- mod: fin add
//-- fin mod : daroPL_AntiSpam ---------------------------------------------
		);
...
//-- mod : daroPL_AntiSpam -------------------------------------------------
//-- mod : add
			'ANTISPAM'              => $confirm_code_name_field,
			'CONFIRM_FIELD_SIZE'    => rand(8,20),
//-- fin mod : daroPL_AntiSpam ---------------------------------------------
